var Instagram = (function(){
	...
	return {
		init:function(){
			...
			var uid = $(".instagram").attr("data-user-id");
			if(!insid){
      ...
      if(!uid){
        alert("You forget to set your instagram user_id.\nPlease see the info on the console of your brower.");
        console.log("Please see 'http://jelled.com/instagram/lookup-user-id#' to lookup your user-id.");
        return;
      }
			getList("https://api.instagram.com/v1/users/"+uid+"/media/recent/?client_id="+insid+"&count=100");
			bind();
		}
	}
})();
